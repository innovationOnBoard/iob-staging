        ...
        <div class="12u$(small)">
            <ul class="timeline">
                ...
                <li class="timeline-item">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <h3 class="timeline-title">Sam Wadsworth CSO Aspect BioSystems</h3>
                        <p><span class="timeline-desc">Pre-registration workshop</span> | Listen to a local success story of Sam Wadsworth CSO of Aspect Biosystems. How to turn a futuristic idea of 3d printing organs and turn this idea into a successful venture.</p>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
                ...
                <li class="timeline-item period">
                    ...
                    <div class="timeline-marker"></div>
                    <div class="timeline-content">
                        <span class="button timeline-title header-inner">February 2017</span>
                    </div>
                </li>
                <li class="timeline-item">
                    <div class="timeline-info">
